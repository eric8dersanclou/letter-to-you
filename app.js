      ...
      html += `
        <div class="envelope-card cover-${letter.coverStyle}" onclick="openLetter('${letter.id}')">
          ...
          <div class="envelope-body">
            <div class="stamp">
              <div class="stamp-inner">${style.icon}</div>
            </div>
            ...
            <div class="envelope-bottom-deco">
              <span class="bottom-hearts">♡ ♡ ♡</span>
            </div>
          </div>
...
function updatePreview() {
  ...
  document.getElementById('preview-stamp-icon').textContent = style.icon;
...
function resetAnimation() {
  isAnimating = false;
  document.getElementById('envelope-scene').classList.remove('hidden');
  document.getElementById('env-flap').classList.remove('flap-opened');
  document.getElementById('flap-seal').classList.remove('seal-break');
  document.getElementById('letter-paper').classList.remove('letter-slide-out');
  document.getElementById('letter-content-page').classList.remove('content-show');
  document.getElementById('confetti-layer').classList.remove('show');
...
function startOpenAnimation() {
  ...
  document.getElementById('flap-seal').classList.add('seal-break');
  generateConfetti();
  
  // 第二步：信纸滑出
  setTimeout(() => {
    document.getElementById('letter-paper').classList.add('letter-slide-out');
  }, 600);
  
  // 第三步：显示内容
  setTimeout(() => {
    document.getElementById('envelope-scene').classList.add('hidden');
    document.getElementById('letter-content-page').classList.add('content-show');
  }, 1200);
  
  // 第四步：撒花彩纸
  setTimeout(() => {
    document.getElementById('confetti-layer').classList.add('show');
    setTimeout(() => {
      document.getElementById('confetti-layer').classList.remove('show');
    }, 3000);
  }, 1400);
